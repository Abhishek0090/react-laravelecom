...
function Product() {
  ...
  const submitProduct = (e) => {
    ...
    formData.append('meta_descriptiontion', productInput.meta_description);
              ...
              <div className="tab-pane card-body border fade" id="otherdetails" role="tabpanel" aria-labelledby="otherdetails-tab">
                ...
                <div className="row">
                  ...
                  <div className="col-md-8 form-group mb-3">
                    <label>Image</label>
                    <input type="file" name="image" id="upload_image" onChange={handleImage} className="form-control" />
